...
/**
 * Interface that is used to store a new cash movement according to the kind of operation.
 *
 * @author Roque Rueda
 * @since 26/05/2014
 * @version 1.0
...
public interface AddCashState {
     ...
     */
    boolean saveCashMovement(Movement m);
